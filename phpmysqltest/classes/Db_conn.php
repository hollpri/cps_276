...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'hmprice';//this will be your WCC username
      $dbUsr = 'hmprice';//this will be your WCC username
      $dbPass = 'VPZsuQXX9zzcuW0';//this will be the password found in the video.
